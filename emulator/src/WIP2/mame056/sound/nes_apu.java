...
import static WIP2.mame056.cpu.m6502.n2a03.n2a03_irq;
...
import static WIP2.mame056.sound.nes_defsH.*;
...
public class nes_apu extends snd_interface
{
    ...
    public void update() {
        ...
        for (i = 0; i < chip_max; i++) {
            apu_update(i);
            APU[i].buf_pos = 0;
            WIP2.mame037b11.sound.mixer.mixer_play_streamed_sample_16(channel + i, new ShortPtr(APU[i].buffer), buffer_size, real_rate);
        }
    }
